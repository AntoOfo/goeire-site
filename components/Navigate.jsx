  ...
  return (
    ...
    >
      <div className="flex justify-between">
        <div className="w-[clamp(18.75rem,39.43vw,37.5rem)]">
          ...
          <div className="flex items-center gap-[clamp(0.44rem,0.92vw,0.88rem)] mb-[clamp(1.13rem,2.36vw,2.25rem)] mt-[clamp(1.13rem,2.36vw,2.25rem)]">
            <img
              src={Pin}
